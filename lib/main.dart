            ...
            actions: [
              TextButton(
                  style: TextButton.styleFrom(
                      ...
                      backgroundColor: Color.fromARGB(168, 113, 25, 19)),
                  onPressed: () async {
                    var result = await _userService.deleteUser(userId);
                    if (result != null) {
                      Navigator.pop(context);
                      getAllUserDetails();
                      _showSuccessSnackBar('Plant Detail Deleted Success');
                    }
                  },
              ...
              TextButton(
                  style: TextButton.styleFrom(
                      primary: Colors.white, // foreground
                      backgroundColor: Color.fromARGB(255, 152, 193, 159)),
                  onPressed: () {
                    Navigator.pop(context);
                  },
                ...
                trailing: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                        ...
                        icon: const Icon(
                          Icons.delete,
                          color: Color.fromARGB(182, 124, 38, 31),
                        ))
                  ],
                ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
            ...
            if (data != null) {
              getAllUserDetails();
              _showSuccessSnackBar('Plant Detail Added Success');
            }
          });
        },
